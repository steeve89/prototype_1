...
(function($){
    ...
    window.A13FRAMEWORK_ADMIN = {
		...
		demoDataImporter : function(){
			...
			if(demo_grid.length){
                var log_div_container      = $('#demo_data_import_log'),
                    log_div                = log_div_container.children('div'),
                ...
                //log link event
                $('#a13_import_demo_data_log_link').on('click',switchLogDiv);
