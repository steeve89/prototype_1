...
/*jQuery( document ).ready(function( jQuery ) {
    if(jQuery('#secondary').size() ){
        if(jQuery('#content').width()>725){
            if(jQuery('#secondary').height() >= jQuery('.content-box').height() ) {
                jQuery('.content-box').css('height', jQuery('#secondary').height()+10);            
            } else {            
                jQuery('#secondary').css('height', jQuery('.content-box').height());
            }
        }
    }
});*/
...
// Ajuster la hauteur de la sidebar avec le contenu
...
ma_fonction();
var x = window.setInterval(ma_fonction, 5000);
*/
/*
 * 
 * FONCTIONS
...
function displaySlides(n) {  
    var i;  
    var slides = window.document.getElementsByClassName("showSlide");  
